 ...
 * @method static \Illuminate\Database\Eloquent\Builder|\App\Models\User whereLastActiveAt($value)
...
{
    use HasApiTokens, Traits\ActiveUserHelper, Traits\LastActivedAtHelper, HasRoles, Notifiable{
